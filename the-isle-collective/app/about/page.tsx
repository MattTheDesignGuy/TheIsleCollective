        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 text-charcoal/70 leading-relaxed">
              ...
              <p>
                That&apos;s where we come in. We design practical AI systems that handle the routine, the repetitive, and the time-consuming — so you can focus on the things that only you can do.
              </p>
              <p>
