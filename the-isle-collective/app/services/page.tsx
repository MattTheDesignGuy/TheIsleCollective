    ...
    <div className="pt-20">
      ...
      <section className="relative text-white py-32 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-[60vh] flex items-center">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-gradient-to-br from-dark/95 via-navy/80 to-ocean/60" />
      ...
      <Section className="bg-dark">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((svc) => (
            <div key={svc.title} className="bg-dark-surface border border-white/8 rounded-2xl p-8 hover:border-ocean/30 hover:shadow-lg hover:shadow-ocean/5 transition-all duration-300">
      ...
      <div className="relative h-72 sm:h-96 overflow-hidden">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-dark/80 flex items-center">
      ...
      <Section className="bg-dark-surface border-y border-white/8">
        ...
        <div className="rounded-2xl overflow-hidden border border-white/10">
          <table className="w-full text-sm">
            ...
            <tbody>
              {addOns.map((row, i) => (
                <tr key={row.service} className={`border-b border-white/5 ${i % 2 === 0 ? "bg-dark-surface" : "bg-dark/50"}`}>
